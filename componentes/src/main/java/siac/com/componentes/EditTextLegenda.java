...
public class EditTextLegenda extends FrameLayout {
    ...
    public EditTextLegenda(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        obtainStyledAttributes(context, attrs, 0);
        init();
    }

    public EditTextLegenda(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
