...
public class EditTexCurrencyLegenda extends FrameLayout {
    ...
    public EditTexCurrencyLegenda(@NonNull Context context) {
        super(context);
        obtainStyledAttributes(context, null, 0);
        init();
    }

    public EditTexCurrencyLegenda(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        obtainStyledAttributes(context, attrs, 0);
        init();
    }

    public EditTexCurrencyLegenda(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
