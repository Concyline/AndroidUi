...
public class EditTextSubtitle extends FrameLayout {
    ...
    public EditTextSubtitle(@NonNull Context context) {
        super(context);
        obtainStyledAttributes(context, null, 0);
        init();
    }

    public EditTextSubtitle(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        obtainStyledAttributes(context, attrs, 0);
        init();
    }

    public EditTextSubtitle(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
